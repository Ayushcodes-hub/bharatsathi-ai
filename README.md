...
Configure your backend environment variables (GITHUB_TOKEN) in a local .env file.
...
CMD cd /app/backend && uvicorn main:app --host 0.0.0.0 --port 8000 & cd /app/frontend && npm un start -- -p 7860
